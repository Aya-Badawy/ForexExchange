...
class RegisterController extends Controller
{
    ...
    */
    ...
    //will pass a new userid/token into user_activation_table.
    //and send mail after registartion is success.
    ...
    public function register(Request $request) {
          ...
          if ($validator->passes()){
            ...
            Mail::send('mail.activation', $user, function($message) use ($user){
              ...
              $message->subject('www.forexExchange.com - Activation Code');
            });
